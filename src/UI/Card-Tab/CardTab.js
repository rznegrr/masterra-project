...
const CardTab = () => {
  return (
    <div className="flex justify-center items-stretch">
      <section className="pt-10 md:pt-20 grid grid-cols-12 mx-2 w-[96vw] h-[200px] xs:h-[230px] sm:h-[350px] md:h-[450px] lg:h-full">
        <div className="col-span-12 grid grid-cols-12 gap-x-3 h-[65px] xs:h-[79px] md:h-[145px] lg:h-[195px] xl:h-[276px]">
          <img className="col-span-3 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic1} alt="category" />
          <img className="col-span-3 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic2} alt="category" />
          <img className="col-span-6 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic5} alt="category" />
        </div>
        <div className="col-span-12 grid grid-cols-12 gap-x-3 my-2 md:my-3 h-[65px] xs:h-[79px] md:h-[145px] lg:h-[195px] xl:h-[276px]">
          <img className="col-span-6 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic6} alt="category" />
          <img className="col-span-3 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic3} alt="category" />
          <img className="col-span-3 rounded-xl sm:rounded-3xl cursor-pointer self-stretch" src={pic4} alt="category" />
        </div>
